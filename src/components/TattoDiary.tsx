import { useState, useEffect, useLayoutEffect, useRef, useMemo, type SVGProps } from 'react';
...
import { SheetStarDivider, MetaLabel, MetaValue, SectionDivider, SectionHeader } from './ui/TextAtoms';
...
import { SkinTonePalette, SessionPhotos, UrgencyChips } from './client/ClientControls';
...
import { urgencyRank, urgencyMeta, notesUrgencyCounts, urgencyCounts } from '../domain/taskSelectors';
import {
  lastSession,
  lastSessionDate,
  nextPlannedSession,
...
import type { OverdueItem, HealingItem, UpcomingSoonItem, ProjectSessionReminderItem, TaskReminderItem } from '../reminders/types';
import {
  overdueEntries,
  healingReminders,
