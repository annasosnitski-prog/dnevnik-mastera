// Модальная обёртка вокруг NoteComposer (DetailScreen.tsx) — сам композер
// раньше был доступен только заинлайненным внутри вкладки «Заметки» клиента
// и внутри экрана «Сводка»; эта шторка даёт то же самое как обычный bottom
// sheet, чтобы «Заметка» могла быть опцией единой CreateChoiceSheet отовсюду
