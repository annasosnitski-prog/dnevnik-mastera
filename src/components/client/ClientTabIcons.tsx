...
// Monumental minimalism: one shared viewBox, currentColor, no decorative
// frame. The glyphs are intentionally blunt and heavy so they read as signs
// at phone distance rather than as fine jewellery details.
